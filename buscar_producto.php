...
<td scope="col"><b>Stock</b></td>
<td scope="col"><b>Precio $</b></td>
<td scope="col"><b>Estado</b></td>
<td scope="col"><b>Fecha Increso</b></td>
<td></td>
<td></td>
</tr>
...
$queryNombre="SELECT * from producto where descripcion LIKE '$nombre_b%' ORDER BY producto.codigo ASC ";
...
while ($wow = $resulNombre->fetch_assoc())
{
  $id_p=$wow['id_p'];
  $codigo=$wow['codigo'];
  $nombre=$wow['descripcion'];
  $precio=$wow['precio'];
  $control=$wow['control_stock'];
  $estado=$wow['estado'];
  $fecha=$wow['fecha_vencimiento'];
  ...
  ?>
    ...
    <td scope="row"><?php echo $control; ?></td>
...
<td><a href="actualizar_producto.php?id=<?php echo $id_p;?>"><img width="40px" height="40px" src="img/modicar.png" /></a></td>
<td><a title="No se puede eliminar -- Modifique su estado de Activo a Inativo"><img width="40px" height="40px" src="img/eli.png" /></a></td>
   </tr>
