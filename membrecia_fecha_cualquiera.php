...
<a href="homeAdmin.php"><img height="50px;" width="50px" src="img/ir.png" /></a>
...
<input style="font-size:22px" type="text" name="cantidad" placeholder="Cantidad de Horas a pagar" value="1" /><br /><br />
...
<br /><br />
<label>Fecha del Pago :</label><input type="date" name="fecha_pago" style="font-size:22px" title="Introducir una fecha X" required="required" />
<br /><br />
<br /><br />
...
$queryPagar_Membre="INSERT INTO `menbre` (`id`, `tipo`, `precio`, `fecha_pago`, `codigo_c`, `id_e`) VALUES (NULL, 'Mensual', '$total_mensual', '$fecha_pago', '$codigo_c', '".$_SESSION['id']."');";
...
$queryPagar_Membre="INSERT INTO `menbre` (`id`, `tipo`, `precio`, `fecha_pago`, `codigo_c`, `id_e`) VALUES (NULL, 'Quincenal', '$total_quincenal', '$fecha_pago', '$codigo_c', '".$_SESSION['id']."');";
...
$queryPagar_Membre="INSERT INTO `menbre` (`id`, `tipo`, `precio`, `fecha_pago`, `codigo_c`, `id_e`) VALUES (NULL, 'Diario', '$total_precio_diarios', '$fecha_pago', '$codigo_c', '".$_SESSION['id']."');";
...
$total_semanal=$semanal*$cantidad;
	...
	$queryPagar_Membre="INSERT INTO `menbre` (`id`, `tipo`, `precio`, `fecha_pago`, `codigo_c`, `id_e`) VALUES (NULL, 'Semanal', '$total_semanal', '$fecha_pago', '$codigo_c', '".$_SESSION['id']."');";
