...
<?php
$id = $_GET['id'];
$query = "SELECT codigo from cliente where  id_c='$id'"; 
...
<input type="text" name="codigo_c"  value="<?php echo $codigo; ?>"/><br /><br />
...
{
  echo "<script>alert('Error Codigo no Exite - Confirme codigo '); window.location='membrecia_pagar.php'; 
</script>";
}
else
{
...
$queryPagar_Membre="INSERT INTO `menbre` (`id`, `tipo`, `precio`, `fecha_pago`, `codigo_c`, `id_e`) VALUES (NULL, 'Mensual', '500', '$date', '$codigo_c', '".$_SESSION['id']."');";

$result_membre=$mysqli->query($queryPagar_Membre);
if($result_membre)
{
  echo "<script>alert('Pago Mensual Realizado Exictosamente'); window.location='homeAdmin.php'; 
</script>";
}
}
//cIERRO MENSUAL
...
$queryPagar_Membre="INSERT INTO `menbre` (`id`, `tipo`, `precio`, `fecha_pago`, `codigo_c`, `id_e`) VALUES (NULL, 'Quincenal', '$quincenal', '$date', '$codigo_c', '".$_SESSION['id']."');";

$result_membre=$mysqli->query($queryPagar_Membre);
if($result_membre)
{
  echo "<script>alert('Pago Quincenal Realizado Exictosamente'); window.location='homeAdmin.php'; 
</script>";
}
}
//CIERRO qUINCENAL
...
$queryPagar_Membre="INSERT INTO `menbre` (`id`, `tipo`, `precio`, `fecha_pago`, `codigo_c`, `id_e`) VALUES (NULL, 'Diario', '35', '$date', '$codigo_c', '".$_SESSION['id']."');";

$result_membre=$mysqli->query($queryPagar_Membre);
if($result_membre)
{
  echo "<script>alert('Pago diario Realizado Exictosamente'); window.location='homeAdmin.php';  
</script>";
}
}
//CIERRO diaria
...
{
  $queryPagar_Membre="INSERT INTO `menbre` (`id`, `tipo`, `precio`, `fecha_pago`, `codigo_c`, `id_e`) VALUES (NULL, 'Semanal', '$semanal', '$date', '$codigo_c', '".$_SESSION['id']."');";

$result_membre=$mysqli->query($queryPagar_Membre);
if($result_membre)
{
  echo "<script>alert('Pago Semanal Realizado Exictosamente'); window.location='homeAdmin.php'; 
</script>";
}
}
//cIERRO SEMANAL 
