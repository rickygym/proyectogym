...
$queryMaxId="SELECT MAX(codigo)+1 As 'codigo' FROM producto";
...
<form action="log_guardar_producto.php" method="post" enctype="multipart/form-data">
  <div class="form-group">
<input size="15px" type="text" name="codigo" class="form-control"  value="<?php echo $codigo; ?>"   required="required"/><br />
<input size="50px" type="text" class="form-control"  name="descripcion" placeholder="Nombre del producto"   required="required" autofocus="" /><br />
<input size="15px" type="text" name="precio" class="form-control"  placeholder="Precio $$$"required="required"/><br />
<input size="15px" type="text" name="stock" class="form-control"  placeholder="Stock"required="required"/><br />

<input type="submit" name="guardar_producto" class="btn btn-success" value="Guardar Producto" />
