    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Listado de 
            <small>Clientes Atrasados...</small>
          </h1>
          <ol class="breadcrumb">
...
<thead class="thead-dark">
        ...
        <tr>
        <td  scope="col" ><b>Foto</b></td>
        <td  scope="col"><b>Codigo</b></td>
        <td scope="col"><b>Nombres</b></td>
        <td scope="col"><b>Apellidos</b></td>
        <td scope="col"><b>Direccion</b></td>
        <td scope="col"><b>Tipo Membrecia</b></td>
        <td scope="col"><b>Fecha de ultimo Pago</b></td>
        <td scope="col"><b>Dias despues del pago</b></td>
        <td></td>
        </tr>
</thead>
  <tbody>
...
$resultado = $mysqli->query("SELECT  cliente.id_c,cliente.foto,menbre.id,cliente.codigo,cliente.nombres,cliente.apellidos,
...
ORDER by dia_despues_del_ultimo_pago DESC");
...
while ($fila = $resultado->fetch_assoc())
 {
	...
	$id_c=$fila['id_c'];
	 ...
	 if(($tipo=='Mensual'&& $dia>30) || ($tipo=='Quincenal'&& $dia>15)) 
	 {
		  $i++;
      ?>
...
<td style="border-top-color:#F00; border-color:#F00">
...
?>
        ...
        <td><a title="Bloquear"  href="bloquear_cliente.php?id=<?php echo $id_c;?>"><img width="25px" height="25px" src="img/eli.png" /></a></td>
        </tr>
...
<h3> Cantidad de Cliente Atrasados <?php echo $i; ?></h3>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
