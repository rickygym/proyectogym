...
<h1>Listado de Clientes Nuevos de Hoy <?php echo date("d-m-Y"); ?></h1>
<br />
...
$resultado = $mysqli->query("SELECT cliente.foto, max(menbre.id),cliente.codigo,cliente.nombres,cliente.apellidos,cliente.direccion, menbre.tipo, menbre.fecha_pago, datediff('$fecha_de_hoy',menbre.fecha_pago) As 'dia_despues_del_ultimo_pago'
FROM menbre INNER JOIN cliente on cliente.codigo=menbre.codigo_c
WHERE menbre.tipo='Mensual' or menbre.tipo='Quincenal' or menbre.tipo='Semanal'
	...
	$imagen=$fila['foto'];
	 ...
	 if($dia==0)
	 {
      ...
      ?>
        ...
        <td style=" border-color:#0F0"><?php echo $dia; ?></td>
        </tr>
...
<div id="estilo">
 <h3 align="center"> Cantidad de Cliente Registrado Hoy <?php echo $i; ?></h3>
 </div>
</body>
</html>