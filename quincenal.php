...
<title>Atrasados Quincenal</title>
</head>
...
<h1>Listado de Clientes Atrasados Quincenales</h1>
<br />
...
WHERE menbre.tipo='Quincenal' and cliente.estado='activo'
...
while ($fila = $resultado->fetch_assoc())
 {
	 ...
	 if($dia>15)
	 {
      ...
      ?>
        ...
        <td style="border-top-color:#F00; border-color:#F00"><?php echo $dia-15; ?></td>
        </tr>
...
<div id="estilo">
 <h3 align="center"> Cantidad de Cliente Quincenales Atrasados <?php echo $i; ?></h3>
 </div>
 </style> 
